...
// 分享图标 (1.8.23 换 iOS 共享样式, 用户点名「现在的太像上传了」):
// 方框 + 箭头从顶边缺口向上出 —— 原先的开口托盘 + 深入盘内的箭杆是
// 「上传」的通用画法, 分享的箭杆只到顶边为止
const ICON_ACTION_SHARE = '<svg viewBox="0 0 24 24" width="15" height="15" aria-hidden="true"><path d="M12 9.5v-6M8.5 7 12 3.5 15.5 7M9.4 10.5H6v8a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-8h-3.4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>';
