...
条目按版本段分家: 1.8 前段 (1.8.19 起, 活跃) / 1.8.17–1.8.18 / 1.8
中段 (1.8.14–1.8.16、1.8.10–1.8.13 和 1.8.5–1.8.9 三段) / 1.8 后半
(1.8.0–1.8.4) / 1.7 / 1.4–1.6 / 1.0–1.3 各一个数据文件 (1.8 线
2026-09-18/19 超重拆了五次)。
"""
